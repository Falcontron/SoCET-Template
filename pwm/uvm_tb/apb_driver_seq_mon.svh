...
class apb_master_drv extends uvm_driver#(apb_rw);
  ...
  `uvm_component_utils(apb_master_drv)
   ...
   virtual task run_phase(uvm_phase phase);
	 ...
	 apb_rw::IDLE:  drive_wait(tr.data);
       endcase
   ...
   virtual protected task drive_wait(input bit [31:0] data);
   ...
   virtual task run_phase(uvm_phase phase);
     ...
     forever begin
       ...
       do begin
         ...
         tr.data = (tr.apb_cmd == apb_rw::READ) ? this.vif.monitor_cb.PRDATA : ((tr.apb_cmd == apb_rw::WRITE) ? this.vif.monitor_cb.PWDATA : '0);
